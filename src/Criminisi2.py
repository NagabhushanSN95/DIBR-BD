...
# Criminisi et. al. inpainting - Modified wrapper code
# https://github.com/igorcmoura/inpaint-object-remover/blob/master/inpainter/inpainter.py
...
class Inpainter():
    def __init__(self, image, mask, patch_size=9, search_area_size=255, plot_progress=False):
    ...
    def _calc_patch_difference(self, image, target_patch, source_patch):
        ...
        # )  # tie-breaker factor
        overall_distance = squared_distance
