...
# Copied from VSR002/data_loaders/Ours03.py and updated for this model
...
class OurDataLoader:
    ...
    def load_data(self, video_name: str, frame1_num: int, patch_start_pt):
        warped_frame2_path = self.dataroot / video_name / f'PoseWarping05/1step/warped_frames/{frame1_num + 1:04}.png'
        mask2_path = self.dataroot / video_name / f'PoseWarping05/1step/disocclusion_masks/{frame1_num + 1:04}.png'
        infilled_depth2_path = self.dataroot / video_name / f'InfilledDepth01/1step/infilled_depths/' \
                                                            f'{frame1_num + 1:04}.npz'
    ...
    def load_test_data(self, video_name: str, frame3_num: int, patch_start_pt):
        data_dict = self.load_data(video_name, frame3_num, patch_start_pt)
        return data_dict
